...
| [`backlog/`](backlog/README.md) | Ideas / debt / deferred items not yet mature enough for an ADR | One file per topic, or grouped by theme — see `workflow.md` for granularity patterns |
| [`testing.md`](testing.md) | Testing strategy: levels, philosophy, what we don't test | Living |
