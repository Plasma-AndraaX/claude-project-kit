...
| [`backlog/`](backlog/README.md) | Idées / dette / sujets différés pas encore mûrs pour une ADR | Un fichier par thème, ou groupé — voir `workflow.md` pour les patterns de granularité |
| [`testing.md`](testing.md) | Stratégie de test : niveaux, philosophie, ce qu'on ne teste pas | Vivant |
...
| [`claude-code-tooling.md`](claude-code-tooling.md) | Inventaire des plugins/skills/hooks Claude Code utilisés sur ce projet | Vivant |
