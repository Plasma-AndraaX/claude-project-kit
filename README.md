...
**Version actuelle : [0.2.0](CHANGELOG.md#020---2026-07-02)** — voir [`CHANGELOG.md`](CHANGELOG.md) pour l'historique lisible par un humain (distinct du tampon `.claude-project-kit-version`, qui sert au diff précis de `/propose-kit-improvement`).
